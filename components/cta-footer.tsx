        ...
        <Reveal className="mt-12 flex flex-col gap-10 sm:mt-16 sm:flex-row sm:items-end sm:justify-between">
          <div className="flex flex-col gap-4">
            ...
            <a
              ...
              className="group inline-flex w-fit flex-col font-mono text-lg text-paper sm:text-2xl"
            >
              {cta.email}
          ...
          <div className="flex flex-col items-start gap-8 sm:items-end">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group inline-flex w-fit flex-col font-mono text-sm uppercase tracking-[0.2em] text-paper sm:text-base"
            >
            ...
            <button
              ...
              className="group flex flex-col items-center gap-3 font-mono text-xs uppercase tracking-[0.3em] text-muted transition-colors hover:text-accent"
            >
              <span
                aria-hidden="true"
                className="block h-8 w-px bg-line-strong transition-colors group-hover:bg-accent"
              />
              {cta.backToTop}
            </button>
          </div>
